...
export default function MapWithSidePanel({ content }: { content: PostType }) {
  ...
  return (
    <div className="bg-white w-full p-4 overflow-auto">
      ...
      <div className="flex gap-4">
        <button className="bg-blue-600 text-white px-4 py-2 rounded cursor-pointer">Directions</button>
        <button className="bg-blue-500 text-white px-4 py-2 rounded cursor-pointer">Save</button>
        <button className="bg-blue-600 text-white px-4 py-2 rounded cursor-pointer">Share</button>
      </div>
    </div>
  );
}
